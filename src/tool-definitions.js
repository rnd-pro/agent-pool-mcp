  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        allowed_tools: { type: 'array', items: { type: 'string' }, description: 'Provider tool allowlist passed to compatible runners. For Claude, entries map to --allowedTools, e.g. "Bash(node --check *)".' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        allowed_tools: { type: 'array', items: { type: 'string' }, description: 'Provider tool allowlist override for compatible runners.' },
        ...DELEGATE_CONTEXT_PROPERTIES,
